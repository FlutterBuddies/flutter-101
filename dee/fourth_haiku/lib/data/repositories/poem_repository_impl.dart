...
import 'package:haiku_generator/api/api_key.dart';
...
class PoemRepositoryImpl implements PoemRepository {
  ...
  Future<String> getPoems(String productName) async {
    var apiKey = palmApiKey;
    const haikuCount = 5;

    final url = Uri.parse('https://generativelanguage.googleapis.com/v1beta2/models/chat-bison-001:generateMessage?key=$apiKey');
